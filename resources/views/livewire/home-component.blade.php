    ...
    <div class="hidden md:block w-full md:w-auto" id="menu">
      <nav
        ...
        @auth
          ...
          <li><a class="py-2 inline-block md:text-white md:hidden lg:block font-semibold" href="{{ route('admin.dashboard') }}">Dashboard</a></li>
          ...
          <li class="md:ml-4"><a class="py-2 inline-block md:text-white md:px-2 font-semibold" href="#">ContactUs</a></li>
          <li class="md:ml-4">
            <a class="inline-block font-semibold px-4 py-2 text-white bg-blue-600 md:bg-transparent md:text-white border border-white rounded hover:bg-sky-700"
...
<div class="bg-gray-100">
  ...
  items-center">
    <div class="h-full absolute top-0 left-0 z-0">
      <img src="{{ asset('img/cover-bg.jpg') }}" alt="" class="w-screen h-full object-cover opacity-20">
    </div>
