...
var categorySelect = document.querySelectorAll('.select-category');

for (var i = 0; i < categorySelect.length; i++) {
  categorySelect[i].addEventListener("click", function (e) {
    var category = e.target.innerText;
    categorySelect.forEach(function (el) {
      return el.classList.remove("bg-teal-300");
    });
    this.classList.add("bg-teal-300");

    _toConsumableArray(productDivs).forEach(function (item) {
      var display = item.dataset.category === category || category === 'all';
